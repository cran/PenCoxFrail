...
\docType{package}
\title{
A ridge approach for Cox Frailty Models.}
\description{A ridge regression approach for Cox Frailty Models based on the Cox full likelihood is provided.
}
\details{
The \code{coxridge} algorithm is designed to investigate
...
The penalty is depending on the ridge tuning parameter \eqn{\xi}.ridge, which has to be determined by a suitable technique, e.g. by K-fold cross validation.
...
\arguments{
  ...
  \item{xi.ridge}{the ridge-penalty parameter that controls the strenght of the penalty term.
